...
% Test: inference on a simple model using sparse data-specified factors
...
factor_graphs(1).factors(1).data=sparse([0.1, 0.7]');
factor_graphs(1).factors(2).type='unary2';
factor_graphs(1).factors(2).vars=[2];
factor_graphs(1).factors(2).data=sparse([0.3, 0.6]');
factor_graphs(1).factors(3).type='pairwise';
factor_graphs(1).factors(3).vars=[1 2];
factor_graphs(1).factors(3).data=sparse([0.0, 0.3, 0.2, 0.0]');
