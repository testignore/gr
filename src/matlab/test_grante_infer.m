...
% Test: inference on a simple model using shared factors
...
% Infer with multichain Gibbs
options=[];
options.verbose=1;
[fg_infer2, logz_result2] = grante_infer(model, factor_graphs, 'mcgibbs', options);
